...
export function PlayingCard<T extends React.ElementType>({
    ...
    return (
          ...
          <div className={clsx(className, 'select-none', { 'animate-flip-slow mirror': isFlipping })} onClick={onClick}>
            <div
            ...
            >
              ...
              {/* {children} */}
              {isShowing ? 
                <div className={`w-32 h-48 bg-white border-2 border-${suit.color} rounded-md flex flex-col justify-between p-2`}>
